...
Waiting on your go-ahead. Two dates are driving everything:

- **September 15** — your festival submissions close. Nothing gets touched
  before then.
- **October 24** — your PowWeb hosting renews. The point of the schedule is to
  have you off it well before you are charged for another year.
...
- PowWeb has been absorbed into Network Solutions, which explains the service
  problems — the company you signed up with effectively no longer exists.
- The site is hand-built HTML from around 1997. No database, nothing running
  behind it. That makes it the easiest kind of site to move and the cheapest to
  keep online.
- Your domain registration is fine and paid through September 2027. It is only
  the hosting that needs dealing with.
